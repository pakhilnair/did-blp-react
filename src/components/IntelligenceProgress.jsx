...
const IntelligenceProgress = ({ metric, link, color, value, icon }) => {
  return (
    <div className="flex flex-col items-center my-6 bg-cy">
      <div className="relative size-20 md:size-28">
        ...
        <div className="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
          <FontAwesomeIcon icon={icon} size="lg" md:size="2x" />
        </div>
      </div>
      <div className="flex flex-col items-center  mt-4 ">
        <p className="text-sm md:text-md text-center">{metric}</p>
